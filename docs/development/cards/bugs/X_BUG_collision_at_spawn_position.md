...
- Implemented Option 2: Modified Game constructor to accept options parameter
- GameServer now creates Game with `{ addLocalPlayer: false }`
- Prevents 'local-player' entity from blocking spawn position (20, 10)
