...
**Completion**: When a card is finished, rename it with "X\_" prefix:
...
**Completion**: When an enhancement card is finished, rename it with "X\_" prefix:
...
**Completion**: When a bug report is fixed, rename it with "X\_" prefix:
...
6. **Completion**:
   ...
   - **Card file renamed with "X\_" prefix** to visually indicate completion
   - Example: `FEATURE_navigation_menu.md` → `X_FEATURE_navigation_menu.md`
   - **Gameplan directory renamed with "X\_" prefix** to visually indicate completion
...
- **Cards**: Rename the **file** with "X\_" prefix (e.g., `FEATURE_name.md` → `X_FEATURE_name.md`)
- **Gameplans**: Rename the **directory** with "X\_" prefix (e.g., `gameplans/event-system/` → `gameplans/X_event-system/`)
...
3. **Rename Gameplan Directory**: Rename the gameplan directory with "X\_" prefix to visually indicate completion
...
9. **Feature Complete**:
   ...
   - **Rename card file with "X\_" prefix** (e.g., `FEATURE_name.md` → `X_FEATURE_name.md`)
   - **Rename gameplan directory with "X\_" prefix** (e.g., `gameplans/event-system/` → `gameplans/X_event-system/`)
   - Update gameplan progress to mark all phases complete
   - Final documentation update

**Completion Markers**:

- **Cards**: File renamed with "X\_" prefix (e.g., `FEATURE_name.md` → `X_FEATURE_name.md`)
- **Gameplans**: Directory renamed with "X\_" prefix (e.g., `gameplans/event-system/` → `gameplans/X_event-system/`)
